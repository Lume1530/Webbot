      ...
      <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-purple-100 shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-6 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            {/* Left column: tagline, notification, stats */}
            <div className="flex flex-col items-start w-full md:w-auto gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full">
                <div className="flex items-center bg-white rounded-lg shadow-sm px-4 py-2 min-w-[120px] border border-gray-100 w-full sm:w-auto">
                ...
                <div className="flex items-center bg-white rounded-lg shadow-sm px-4 py-2 min-w-[140px] border border-gray-100 w-full sm:w-auto">
