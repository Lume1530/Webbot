...
interface LoginFormProps {
  ...
  onRegister: (userData: {
    ...
    success: boolean;
    error?: string;
    referrerInfo?: { username: string; email: string };
  }>;
  isLoading: boolean;
  handleRequestOtp: (
    otp: string,
      ...
      if (isLoginMode == true) {
        ...
        if (result.success) {
          if (result.referrerInfo) {
            toast.success(
              `Registration successful! You were referred by ${result.referrerInfo.username} (${result.referrerInfo.email}). Please wait for admin approval.`
            );
          } else {
          ...
          <div className="text-center mb-8 flex justify-center flex-col">
            ...
            {forgotPassword == true ? (
              ...
              <p className="text-gray-300">
                {isLoginMode == null
                  ? "Monetize Your Visuals. It's Time to Get Paid."
                  : isLoginMode
                  ? "Welcome Back"
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 w-full max-w-md border border-white/20">
          ...
          >
            ...
            <div className="pt-2 text-xs">
              <div
                className={`flex items-center ${getStrengthColor(
    ...
    <div className="w-full md:h-screen flex items-center justify-center p-4 bg-[#09090B]">
      <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 w-full max-w-md border border-white/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mb-6">
          ...
          {(isLoginMode == true || isLoginMode == false) && (
            <div>
              <label
                htmlFor="password"
                className="block text-sm font-medium text-gray-200 mb-2"
